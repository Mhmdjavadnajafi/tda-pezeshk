...
const Completetheapplication = () => {
    const navigate = useNavigate()
    return (
        <div className='w-[100%] mx-auto relative'>
            <TestHeader onClick={() => navigate('/CheckTest')} title={'تکمیل درخواست'} />
            ...
            <Chooseinsurance/>
            <Symptoms></Symptoms>
            <RequestButton onClick={() => navigate('/Complete2')} text={'تکمیل اطلاعات'} />
        </div>
    )
}
export default Completetheapplication