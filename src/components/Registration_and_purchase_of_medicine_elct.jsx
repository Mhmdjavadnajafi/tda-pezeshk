...
const Registration_and_purchase_of_medicine_elct = ({ historyTitle, code, status, AttachedservicesTitle, paramName, pike })=>{
    return(
        <div>
            <div className='w-[90%] mx-auto'>
                ...
                <div className='vazir-medium mt-1 text-sm text-gray-600 flex items-center'>
                    کد ثبت : <span className='mr-1 text-red-600'>{code}</span>
                </div>
...
export default Registration_and_purchase_of_medicine_elct