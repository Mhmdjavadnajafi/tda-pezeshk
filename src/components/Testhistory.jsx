...
const HistoryTest = ({ historyTitle, CasesTitle, DrName, Expertise, status, code, AttachedservicesTitle, sampler, Servicecenter }) => {
    return (
        <div>
            ...
            <div className='w-[90%] mx-auto'>
                <div className="vazir-medium gap-3 font-bold text-3 flex items-center  mt-4">
                    <img className='h-3 w-3' src={ICON}></img>  خدمات بیشتر
                </div>
                <div className='mt-2'>
